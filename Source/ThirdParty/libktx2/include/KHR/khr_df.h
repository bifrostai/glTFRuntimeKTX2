...
#define KHR_DFDSETVAL(BDB, X, val) \
	((BDB)[KHR_DF_WORD_##X] =      \
			((BDB)[KHR_DF_WORD_##X] & ~((KHR_DF_MASK_##X) << (KHR_DF_SHIFT_##X))) | (((val) & (KHR_DF_MASK_##X)) << (KHR_DF_SHIFT_##X)))
...
#define KHR_DFDSETSVAL(BDB, S, X, val)                                                          \
	((BDB)[KHR_DF_WORD_SAMPLESTART + ((S) * KHR_DF_WORD_SAMPLEWORDS) + KHR_DF_SAMPLEWORD_##X] = \
			((BDB)[KHR_DF_WORD_SAMPLESTART + ((S) * KHR_DF_WORD_SAMPLEWORDS) + KHR_DF_SAMPLEWORD_##X] & ~((uint32_t)(KHR_DF_SAMPLEMASK_##X) << (KHR_DF_SAMPLESHIFT_##X))) | (((val) & (uint32_t)(KHR_DF_SAMPLEMASK_##X)) << (KHR_DF_SAMPLESHIFT_##X)))
...
#define KHR_DFDSIZEWORDS(S) \
	(KHR_DF_WORD_SAMPLESTART + (S) * KHR_DF_WORD_SAMPLEWORDS)
